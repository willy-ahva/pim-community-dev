...
class CompletenessManager
{
    ...
    {
        if ($channel->getId()) {
            $formerLocales = $this->channelRepository->getLocaleIdsForChannel($channel);
            ...
            $deletedLocales = array_diff($formerLocales, $currentLocales);
            foreach ($deletedLocales as $deletedLocale) {
